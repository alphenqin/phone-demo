...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <!--系统标题-->
        <div class="layui-logo" style="font-size:18px">书评网数据管理系统</div>
        <!--右侧当前用户信息-->
        <ul class="layui-nav layui-layout-right">
            ...
            <!--注销按钮-->
            <li class="layui-nav-item"><a href="/management/book/logout">注销</a></li>
        </ul>
    </div>
    <!--左侧菜单栏-->
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child module" data-node-id="">
    ...
    <div class="layui-footer">
        Copyright © alphen. All Rights Reserved.
    </div>
</div>
<!--LayUI JS文件-->
